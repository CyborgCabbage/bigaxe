...
import net.cyborgcabbage.bigaxe.util.JsonUtil;
...
public class TextureListener implements TextureRegister {
    ...
    public void registerTextures() {
        System.out.println("BIGAXE TEXTURE");
        ...
        //String pathBlock = Bigaxe.getTexturePath("block");
        String pathItem = Bigaxe.getTexturePath("item");
